...
written by Cameron Liang & Andrey Kravtsov.
...
*For users with Python 3 and above, you need to convert all the* ``bayesvp`` *scripts (written originally in Python 2.7) to Python 3 using
